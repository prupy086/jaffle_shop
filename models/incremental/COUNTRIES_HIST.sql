...
(Select c.country_id+'_'+"header__timestamp" as uqid , c."header__operation",c.country_id,c.country_name, c.region_id,c.country_abr_name, c.Country_president_name, c."header__timestamp",c.end_time_raw
from cte c 
where 
